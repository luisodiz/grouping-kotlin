...
class Mushroom(val size: Int, val isMagic: Boolean) {
    constructor(isMagic_param: Boolean) : this(0, isMagic_param) {
        // код при выполнении вторичного конструктора
    }
}
...
fun main() {
    ...
    val r3 = r1.copy(title = "Chicken Bhuna") // Копия с изменением title
    ...
    println("r1 == r2? ${r1 == r2}")
    println("r1 === r2? ${r1 === r2}") // Проверка на ссылки, они разные
    println("r1 == r3 ${r1 == r3}")

    var (title, mainIngredient, vegetarian, difficulty) = r1
